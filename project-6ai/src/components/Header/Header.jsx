...
function Header() {
  ...
  <div className="cart-heart">
    ...
    <div className="icon">
      ...
      <p>Моя корзина</p>
        ...
        <select>
  <option value="" disabled selected>Apple</option>
  ...
  <option value="iphone-14">iPhone 14</option>
        ...
        <select>
          <option value="" disabled selected>Huawei</option>
    ...
    <option value="huawei-mate-40">Huawei Mate 40</option>
          ...
          <select>
          <option value="" disabled selected>Xiaomi</option>
    ...
    <option value="xiaomi-mi-10">Xiaomi Mi 10</option>
        ...
        <select>
        <option value="" disabled selected>Samsung</option>
